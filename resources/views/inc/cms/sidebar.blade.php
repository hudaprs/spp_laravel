        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                ...
                @if(Auth::user()->role->name === 'High Admin')
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('users.index') }}"
                                   class="nav-link {{ Request::is('cms/master/users') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('roles.index') }}"
                                   class="nav-link {{ Request::is('cms/master/roles') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('grades.index') }}"
                                   class="nav-link {{ Request::is('cms/master/grades') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('spp.index') }}"
                                   class="nav-link {{ Request::is('cms/master/spp') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('students.index') }}"
                                   class="nav-link {{ Request::is('cms/master/students') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('payments.index') }}" class="nav-link {{ Request::is('cms/payments') ? 'active' : '' }}">
